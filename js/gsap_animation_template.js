...
gsap.from(".svg-2", {scrollTrigger: {trigger:".paragrafo-2-svg", start:"top 80%"}, duration: 1, x:-200, opacity:0})
...
gsap.from(".svg-3", {scrollTrigger: {trigger:".paragrafo-3-svg", start:"top 80%"}, duration: 1, x:200, opacity:0})
