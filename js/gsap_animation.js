...
.from(".btn-about", { opacity:0.2, delay:1, scale: 0, ease:"back", duration:3})
...
gsap.from("#partner", {scrollTrigger: {trigger:"#partner", start:"top 50%"}, duration: 3, x:2100, opacity:0, rotate: 0})
